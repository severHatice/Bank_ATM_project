...
public class ATM {
	    ...
	    Bakiye sorgula, para yatirma, para cekme, para gönderme, sifre degistirme ve cikis.
	    Para cekme ve para gonderme isleminde mevcut bakiyeden buyuk para cekilemez,
	    Para gönderme isleminde istenen iban TR ile baslamali ve toplam 26 karakterli olmali, eger degilse menü ekranina geri donsun.
